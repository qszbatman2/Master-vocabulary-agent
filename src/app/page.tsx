      ...
      <div className="container mx-auto px-4 py-6 flex-1 flex flex-col">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-2">
            <div className={cn(
              ...
              isDark ? "bg-[#1E1E1E] border border-[#333]" : "bg-white shadow"
            )}>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                ...
                isDark 
                  ? "bg-[#1E1E1E] hover:bg-[#2A2A2A] border border-[#333]" 
            ...
            {user ? (
              <div className="flex items-center gap-2">
                <div className={cn(
                  ...
                  isDark ? "bg-[#1E1E1E] text-white border border-[#333]" : "bg-white shadow text-gray-700"
                )}>
              ...
              <Link href="/login">
                <button className="flex items-center gap-1 px-4 py-1.5 rounded-full bg-[#00E5FF] text-black font-medium text-sm hover:bg-[#00C8DC] transition-all">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-md mx-auto mb-8">
          ...
          <Link href="/vocabulary" className="block">
            <div className={cn(
              "group p-4 rounded-2xl transition-all duration-300 cursor-pointer h-full",
              isDark 
          ...
          <Link href={user ? "/practice" : "/login"} className="block">
            <div className={cn(
              "group p-4 rounded-2xl transition-all duration-300 cursor-pointer h-full",
              isDark 
                ? "bg-[#00E5FF] hover:bg-[#00C8DC]" 
                : "bg-[#00E5FF] hover:bg-[#00C8DC] shadow"
            )}>
              <div className="flex flex-col items-center text-center gap-3">
              ...
              <div className={cn(
                ...
                <div className="mt-4">
                  ...
                  <div className={cn(
                    ...
                    <div 
                      className="h-full rounded-full transition-all duration-500 bg-[#00E5FF]"
                      style={{ 
            ...
            {[
              ...
              <div
                ...
                className={cn(
                  ...
                  isDark ? "bg-[#1E1E1E] border border-[#333]" : "bg-white shadow-sm"
                )}
              >
